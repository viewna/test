...
$.extend( $.validator, {
	...
	methods: {
		...
		email: function( value, element ) {
			...
			// 원래있던거 - return this.optional( element ) || /^[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test( value );
		...
		// http://jqueryvalidation.org/number-method/
		business: function( value, element ) {
